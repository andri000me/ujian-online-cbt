...
<div class="row">
    ...
    <div class="col-sm-8">
        <div class="box box-solid">
            ...
            <div class="box-body">
                <p>Computer Based Test dikembangkan oleh Raffi Baihaqy</p>
                <center>
                <a href="https://www.github.com/raffibaihaqy02/" target="_blank" rel="noopener noreferrer">
                    <img src="<?= base_url('assets/dist/img/ba.png') ?>" width="30%" alt="" srcset="">
                </a>
                </center>
            </div>
        </div>
