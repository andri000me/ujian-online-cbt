        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <div class="form-group">
                    ...
                    <input value="<?=$data->nip?>" autofocus="autofocus" onfocus="this.select()" type="number" id="nip" class="form-control" name="nip" placeholder="NUPTK">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="nama_dosen">Nama Guru</label>
                    <input value="<?=$data->nama_dosen?>" type="text" class="form-control" name="nama_dosen" placeholder="Nama Guru">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
